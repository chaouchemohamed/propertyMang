                                                    ...
                                                    <tbody>
                                                        @foreach ($kycVerifications as $kycVerification)
                                                            <tr class="kycVerificationRow">
                                                                ...
                                                                <td>
                                                                    <img class="img-thumbnail img-responsive w-50"
                                                                        src="{{ $kycVerification->front }}" alt="">
                                                                </td>
                                                                <td>
                                                                    <img class="img-thumbnail img-responsive w-50"
                                                                        src="{{ $kycVerification->back }}" alt="">
                                                                </td>
                                                                <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-25 pb-5">
                                    ...
                                    <input type="file" name="front" class="dropify"
                                        data-allowed-file-extensions="jpeg jpg png" data-max-file-size-preview="3M" />
                                </div>
