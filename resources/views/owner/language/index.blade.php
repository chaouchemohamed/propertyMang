...
@section('content')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="tbl-action-btns d-inline-flex">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('owner.language.delete', [$language->id]) }}"
                                                                                method="post"
                                                                            ...
                                                                            <a href="{{ route('owner.language.translate', [$language->id]) }}"
    ...
    <div class="modal fade" id="addLanguageModal" tabindex="-1" aria-labelledby="addLanguageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('owner.language.store') }}" method="POST" enctype="multipart/form-data"
    ...
    <div id="addLanguageRoute" data-route="{{ route('owner.language.store') }}"></div>
    <div id="editLanguageRoute" data-route="{{ route('owner.language.update', '@') }}"></div>
@endsection
