...
@section('content')
    ...
    <div class="modal fade" id="importModal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form class="ajax" action="{{ route('owner.language.import') }}" method="POST"
    ...
    <input type="hidden" id="updateLangItemRoute" value="{{ route('owner.language.update.translate', [$language->id]) }}">
@endsection
