...
CREATE TABLE `property_details` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` bigint(20) unsigned NOT NULL,
  `lease_amount` decimal(8,2) DEFAULT '0.00',
...
CREATE TABLE `property_units` (
  ...
  `general_rent` decimal(8,2) DEFAULT '0.00',
  ...
  `incident_receipt` decimal(8,2) DEFAULT '0.00',
...
CREATE TABLE `tenants` (
  ...
  `lease_start_date` date DEFAULT NULL,
  `lease_end_date` date DEFAULT NULL,
  `general_rent` decimal(8,2) NOT NULL DEFAULT '0.00',
  `security_deposit_type` tinyint(4) DEFAULT '0',
  `security_deposit` decimal(8,2) NOT NULL DEFAULT '0.00',
  `late_fee_type` tinyint(4) DEFAULT '0',
  `late_fee` decimal(8,2) NOT NULL DEFAULT '0.00',
  `incident_receipt` decimal(8,2) NOT NULL DEFAULT '0.00',
  `status` tinyint(4) NOT NULL DEFAULT '3',
  `close_refund_amount` decimal(8,2) NOT NULL DEFAULT '0.00',
  `close_charge` decimal(8,2) NOT NULL DEFAULT '0.00',
