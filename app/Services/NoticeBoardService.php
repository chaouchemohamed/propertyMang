        ...
        return datatables($noticeboard)
            ...
            ->addColumn('action', function ($noticeboard) {
                ...
                return '<div class="tbl-action-btns d-inline-flex">
                            <button type="button" class="p-1 tbl-action-btn view" data-bs-toggle="modal" data-id="' . $id . '" data-bs-target="#viewNoticeBoardDetailsModal" title="View"><span class="iconify" data-icon="carbon:view-filled"></span></button>
                            ...
                            <button onclick="deleteItem(\'' . route('owner.noticeboard.delete', $id) . '\', \'allDatatable\')" class="p-1 tbl-action-btn"   title="Delete"><span class="iconify" data-icon="ep:delete-filled"></span></button>
                        </div>';
            })
